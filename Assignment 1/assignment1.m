...
availableFunctions="https://www.mathworks.com/help/images/referencelist.html?type=function&s_tid=CRUX_topnav"
...
%
% Answer: The major types of loops is 'for' and 'while'. The difference is
% 'for' tells matlab to repeat a certain amount of times, 'while' tells
% matlab to repeat only when true. 
% 
...
%
% Answer: NaN stands for Not-a-Number. Would get this as an answer when an
% operation has a result such as 0/0 or something equivalent to infinity. 
%
...
% - find the maximum.
vecf=randi([-10 10],1,5)
vecfsubtract=vecf-3
vecfpositive=sum(vecf>0)
vecfabsolutevalue=abs(vecf)
vecfmax=max(vecf)
...
% trapArea finds the area of a trapezoid with a base of 10 and 7 and a
% height of 5
...
y=input('Enter y value here: ')
z=input('Enter z value here: ')
